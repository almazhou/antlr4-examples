...
public interface LabeledExprListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code black}
	 * labeled alternative in {@link LabeledExprParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterBlack(@NotNull LabeledExprParser.BlackContext ctx);
	/**
	 * Exit a parse tree produced by the {@code black}
	 * labeled alternative in {@link LabeledExprParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitBlack(@NotNull LabeledExprParser.BlackContext ctx);
	/**
